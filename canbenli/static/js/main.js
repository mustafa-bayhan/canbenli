...
(function($) {
    ...
    hero_s.owlCarousel({
        ...
        animateOut: 'fadeOut',
    	animateIn: 'fadeIn',
        navText: ['<img src="/media/img/angle-left-w.png" alt="">', '<img src="/media/img/angle-rignt.png" alt="">'],
        smartSpeed: 1200,
        autoHeight: false,
	...
	$('.gallery-single-slider').owlCarousel({
        ...
        items: 1,
        dots: false,
        navText: ['<img src="/media/img/angle-left.png" alt="">', '<img src="/media/img/angle-rignt-w.png" alt="">'],
	});
